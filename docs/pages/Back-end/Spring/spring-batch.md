...
summary: 本文记录Docker相关学习。
keywords: >-
  spring batch,spring 批处理框架,springboot batch,springboot 批处理,spring batch
  job上下文,spring batch step上下文,spring batch 监听器,spring batch 执行上下文,spring batch
  itemreader,spring batch itemwriter,spring batch processor,spring batch
  schedule,spring batch web restful,spring batch xml
