<!-- ---
title: Thymeleaf 内置对象
tags:
  - Thymeleaf
categories:
  - SpringBoot
summary: 本文整理Springboot Thymeleaf 内置对象学习。
keywords: >-
  java,spring boot,spring boot Thymeleaf ,Thymeleaf 语法,Thymeleaf 工具类,Thymeleaf教程,Thymeleaf教程,Thymeleaf 入门,Thymeleaf 进阶
author: Small-Rose / 张小菜
abbrlink: '44478111'
date: 2020-07-26 18:30:00
---
 -->
