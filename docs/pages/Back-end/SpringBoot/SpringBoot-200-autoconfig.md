<!-- ---
title: SpringBoot AutoConfig 自动装配
tags:
  - AutoConfig
categories: SpringBoot
summary: SpringBoot  自动装配原理。
keywords: >-
  java,spring boot,spring boot AutoConfig ,spring AutoConfig,AutoConfig,SpringBoot
  AutoConfig,SpringBoot  AutoConfig 配置
